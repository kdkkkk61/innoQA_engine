...
> **※ 기본 검증 매트릭스 (2026-07-07 확정)**: 아래 항목들은 **필드 전수 × 기본 클래스**로
> 깔려야 한다 — 어딘 3000자만, 어딘 특수문자만 하는 들쭉날쭉 금지. 페이지 마감 전
> 매트릭스 감사 절차·제외 규칙·적용례(폴더동기화)는 `docs/baseline-verification-matrix.md`.
