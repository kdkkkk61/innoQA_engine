...
PAGE_REGISTRY: dict[str, type] = {
    ...
    "secure_zone_template_secure_drive": SecureZoneTemplateSecureDrivePage,
}
...
MODULE_GROUPS: dict[str, list[str]] = {
    ...
    "secure_zone": [
        ...
        "secure_zone_template_secure_drive",  # 5. 템플릿(시큐어드라이브) — 시큐어존 정책이 참조(연계)
        "secure_zone_agent_policy",    # 6. 시큐어존 정책 (템플릿/제어스위트 참조)
    ],
}
